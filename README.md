...
- **Week 04:** CSS Layout: Flexbox vs Grid (1D vs 2D), wrapping flex gallery, space distribution with `justify-content`, responsive CSS Grid (`auto-fit` + `minmax`), mobile-first breakpoints, and CSS positioning (`static`, `relative`, `absolute`, `fixed`, `sticky`).
